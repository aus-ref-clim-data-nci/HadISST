...
with open('/g/data/jt48/aus-ref-clim-data-nci/hadisst/data/HadISST_sst.nc.gz', 'wb') as sst_file:
...
with open('/g/data/jt48/aus-ref-clim-data-nci/hadisst/data/HadISST_ice.nc.gz', 'wb') as ice_file:
